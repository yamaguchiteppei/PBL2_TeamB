    ...
    <div class="column" id="colOthers">
        ...
        <div class="search-bar">
            <div class="search-input-wrap">
                <input id="searchOthers" type="text" placeholder="教科書名・ 学 部・価格で検索..." autocomplete="off" />
        ...
        <?php if (empty($other_books)): ?>
            <p style="text-align:center; color:#666;">現在、購入できる教科書 は ありません。</p>
        <?php else: ?>
...
<div class="book-item <?= $is_sold ? 'sold' : '' ?>"
                    ...
                    <div class="book-info">
                        ...
                        <div class="action-buttons">
                            <form action="message_list.php" method="get">
                                ...
                                <button type="submit" class="message-btn">💬 メ ッセージ</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="column" id="colMine">
        ...
        <div class="search-bar">
            <div class="search-input-wrap">
                <input id="searchMine" type="text" placeholder="自分の教科書 を 検索..." autocomplete="off" />
...
<?php else: ?>
<form action="mark_sold.php" method="post" onsubmit="return confirm('この教科書>を売却済みにしますか？');">
    <input type="hidden" name="index" value="<?= $book['index'] ?>">
    <button class="sold-btn">✔️売却済みにする</button>
</form>
<?php endif; ?>
                        </div>
                    </div>
